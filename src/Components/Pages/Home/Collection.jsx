...
const Collection = () => {
    return (
        <section className="relative mt-[66px]">
            <div className="absolute top-0 right-0 w-1/2 h-full bg-primary -z-10"></div>
            <Container>
                <Flex className="justify-between">
                    <Flex className='w-2/4 justify-between items-center py-[74px] px-[50px]'>
                        <div className='space-y-[41px]'>
                            ...
                            <p className='text-primary text-typography text-[25px]'>Browse More Collection</p>
                        </div>
                    ...
                    <Flex className='w-2/4 justify-between items-center py-[74px] px-[50px]'>
                        <div className='space-y-[41px]'>
                            ...
                            <p className='text-[25px] text-secondary'>Browse More Collection</p>
                        </div>
